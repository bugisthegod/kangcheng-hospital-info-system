...
public class UpdateInspectionItemCommand implements Command<InspectionItemPo,Integer> {

    private InspectionItemCommandHandler handler;

    public UpdateInspectionItemCommand(){
    ...
    public Integer excute(InspectionItemPo inspectionItemPo) {
        return handler.updateInspectionItem(inspectionItemPo);
    }
}
