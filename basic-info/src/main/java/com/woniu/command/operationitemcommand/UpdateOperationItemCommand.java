...
public class UpdateOperationItemCommand implements Command<OperationItemPo,Integer> {

    private OperationItemCommandHandler handler;

    public UpdateOperationItemCommand(){
    ...
    public Integer excute(OperationItemPo operationItemPo) {
        return handler.updateOperationItem(operationItemPo);
    }
}
